...
**Today's Progress**: continue springboot jwt project

**Thoughts:** need to focus on it all the week to come accross configuration issues.
...
**Thoughts:** tomorrow have to start the react/redux? part 

**Link to work:** [Crowdfunding product page](https://www.frontendmentor.io/challenges/crowdfunding-product-page-7uvcZe7ZR)

### Day 77: Mars 18, 2021

**Today's Progress**: Frontend mentor challenge Crowdfunding product page react-state
...
**Today's Progress**: Frontend mentor challenge Crowdfunding product page react-style
...
**Today's Progress**: Frontend mentor challenge Crowdfunding product page fix nav background
